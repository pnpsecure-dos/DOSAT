...
if os_platform == "Windows" :
    os.system("type C:\\jenkins\\sharedspace\\DBSAFER_OS\\TC Test\\test_file\\windows\\%s\\%s"%(tc_num,tc_num))
else :
    os.system("cat /home/jenkins/sharedspace/DBSAFER_OS/TC Test/test_file/posix/%s/%s"%(tc_num,tc_num))
